...
<pre><code class="language-java">static List&ltInteger&gt mergeList(List&ltInteger&gt nums1, List&ltInteger&gt nums2){
    
    int i = 0, j = 0;
    List&ltInteger&gt resultList = new ArrayList&lt&gt();

    while (i &lt nums1.size() && j &lt nums2.size()){
